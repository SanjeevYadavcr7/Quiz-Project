...
<style type="text/css">
	...
	#box12 .box table, th, td {border:2px solid steelblue;border-collapse: collapse;}
	#box12 .box table{width: 90%;}
	#box12 .box th, td{height:30px;text-align: center;}
	#box12 .box td{height:34px;font-size:20px;}
...
<body>
	...
	<nav class="navbar ">
		...
		<div id="box1">
			...
			<div id="box12">
				<div class="box">
					<h1 style="color:black;margin-left: 2%;margin-top:2%; ">My Profile</h1>
					<hr style="border:1px solid steelblue;width: 95%;">
					<br><br>
					<table border="1" align="center" style="width:60%">
						<tr style="background-color:#ccc;" ><td><b>Name</b></td><td>Sanjeev Yadav</td></tr>
						<tr><td><b>Designation</b></td><td>Administrator</td></tr>
						<tr style="background-color:#ccc;"  ><td><b>Authentication</b></td><td>Full Control</td></tr>
						<tr><td><b>Email</b></td><td>sanjeevyadavcr7@gmail.com</td></tr>
						<tr><td><b>Password</b></td><td>sanjeev07</td></tr>
					</table>
				</div>
			</div>
		</div>
