...
<style type="text/css">
	...
	#box114{width:99.9%;height:10%;border-bottom:1px solid white;background: white;}
	#box114 a p{margin-left: 5%;width: 100%;height: 100%;//border:1px solid green;line-height: 3.4;font-weight: bold;color: #B9770E;}
	...
	<nav class="navbar">
		...
		<div id="box1">
			...
			<div id="box11">
				...
				<div id="box114"><a href="#" style="text-decoration: none;color: white;"><p>Show Questions</p></a> </div>
			...
			<div id="box12">
				...
				<div class="container">
				<h1 style="color:black;margin-left: 1%;">Show Questions</h1>
				<hr style = "border:1px solid steelblue;width: 98%;">
				<table border="1" align="center">
					<br>
					<tr style="background-color:#E5E7E9;">
			    		<th>Question No.</th><th>Question</th>
					</tr>
					<?php
