...
#box111{width:99.9%;height:15%;}
	...
	#box117{width:99.9%;height:10%;border-bottom: 1px solid white;border-top:1px solid white;}
	...
	#box118{width:99.9%;height:10%;border-bottom: 1px solid white;background: white;}
	#box118 a p{margin-left: 5%;;width: 100%;height: 100%;//border:1px solid green;line-height: 3.4;font-weight: bold;color: #B9770E;}
	...
	<nav class="navbar ">
		...
		<div id="box1">
			...
			<div id="box11">
				...
				<div id="box112"><a href="admin.php" style="text-decoration: none;color: white;"><p>HOME</p></a></div>
				...
				<div id="box118"><a href="#" style="text-decoration: none;color: white;"><p>Delete Question</p></a></div>
			</div>
			
			<div id="box12">
				<div class="box">
					<h1 style="color:black;margin-left: 2%;margin-top:2%; ">Delete Questions</h1>
					<hr style="border:1px solid steelblue;width: 95%;">
					<form action="" method="POST">
						
							<p>Enter Question No. to be Deleted:
								<input type="number" name="question_number"></p>
							<br>
							OR
							<br><br>
								<p>Enter Question Text  to be Deleted:
								<input type="text" name="t2"></p>
							<br><br>
							
							<input type="submit" name="submit1" value="Delete Question">
							</table>
					</form>
					<?php
					...
					{
						mysql_query("delete from questions where question_number='$_POST[question_number]'");
						mysql_query("delete from choices where question_number='$_POST[question_number]'");
						}
					?>
					<br>
				</div>
